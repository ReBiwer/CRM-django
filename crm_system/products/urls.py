...
from .views import DetailProductView, CreateProductView, ListProductView, DeleteProductView
...
urlpatterns = [
    ...
    path('delete/<int:pk>/', DeleteProductView.as_view(), name='products_detail'),
]
